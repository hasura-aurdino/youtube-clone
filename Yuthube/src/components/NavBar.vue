        ...
        <v-card>
          ...
          <v-list>
            ...
            <v-list-item router to="/studio">
              ...
              <v-list-item-title>Yuthube Studio</v-list-item-title>
            </v-list-item>
        ...
        <v-list dense nav class="py-0" tag="div">
          ...
          >
            <v-app-bar-nav-icon
              ...
              class="mr-5"
            ></v-app-bar-nav-icon>
            <v-toolbar-title class="font-weight-bold">Yuthube</v-toolbar-title>
          </v-list-item>
...
export default {
  data: () => ({
    ...
    items: [
      ...
      {
        header: 'MORE FROM Yuthube',
        pages: [
          {
            title: 'Yuthube Premium',
            link: '#vp',
            icon: 'mdi-youtube'
          },
          {
